...
<p>Parece que la conexión con el servidor es inestable. Agradecemos tu paciencia. Por favor, **vuelve a intentarlo en unos instantes**.</p>
                </div>
            `;
      return;
    }
...
function updateSubcategories() {
  ...
  subcategoriesDiv.innerHTML = subcats
    .map(
      (sub) => `
        <button class="subcategory-btn ${
          sub.id === currentSubcategory ? "active" : ""
        }" 
